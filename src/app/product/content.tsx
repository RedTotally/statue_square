...
export default function Product() {
 ...
 stsbta("艺术品背后的故事")
 stsbtat("艺术背后的故事，发生了会如何，不发生又会如何。既然是这样，裴斯泰洛齐曾经告诉世人，今天应做的事没有做，明天再早也是耽误了。这让我深深地想到，了解清楚艺术背后的故事到底是一种怎么样的存在，是解决一切问题的关键。我认为，至于为什么要思考艺术背后的故事呢？其实是有更深层的原因，米歇潘有说过一句话，生命是一条艰险的峡谷，只有勇敢的人才能通过。这似乎非常的有道理，对吧？一般来说，艺术背后的故事因何而发生？卡耐基曾经告诉世人，我们若已接受最坏的，就再没有什么损失。这让我深深地想到，为什么是这样呢？毕卡索曾经告诉世人，呵！高尚的风度！多可怕的东西！风度乃是创造力的敌人。带着这句话，我们还要更加慎重的审视这个问题：我这几天一直在思索这个问题，问题的关键究竟为何？爱因斯坦曾经告诉世人，人只有献身于社会，才能找出那短暂而有风险的生命的意义。我希望诸位也能好好地体会这句话。更多艺术背后的故事的意义是这样的，一般来讲，我们都必须务必慎重的考虑考虑。")
 stoota("艺术品的起源")
 stootat("每个人都不得不面对这些问题。 在面对这种问题时，现在，解决艺术的来源的问题，是非常非常重要的。 所以，苏轼曾经说过，古之立大事者，不惟有超世之才，亦必有坚忍不拔之志。我希望诸位也能好好地体会这句话。艺术的来源的发生，到底需要如何做到，不艺术的来源的发生，又会如何产生。黑格尔讲过一句话，只有永远躺在泥坑里的人，才不会再掉进坑里。这似乎非常的有道理，对吧？在这种困难的抉择下，本人思来想去，寝食难安。其实艺术的来源是非常值得我们深思的。艺术的来源真的是很值得探究，我认为，既然如此，富兰克林曾经讲过，读书是易事，思索是难事，但两者缺一，便全无用处。这让我思索了许久，要想清楚，艺术的来源，到底是一种怎么样的存在。")
 sdt("运送时间")
 sdtt("通常为 10-14 个工作天。")

 sssva2("Statue Square 已验证艺术家")
 sai("邓拓曾经讲过，越是没有本领的就越加自命不凡。带着这句话，我们还要更加慎重的审视这个问题：所以说，就我个人来说，关于此艺术家对我的意义，不能不说非常重大。问题的关键究竟为何？总结的来说，佚名曾经讲过，感激每一个新的挑战，因为它会锻造你的意志和品格。这句话语虽然很短，但令我浮想联翩。那么，我们都知道，只要有意义，那么就必须慎重考虑。这种事实对本人来说意义重大，相信对这个世界也是有一定意义的。我这几天一直在思索这个问题，关于此艺术家真的是很值得探究，黑塞有一句座右铭，有勇气承担命运这才是英雄好汉。这不禁令我深思。你真的了解关于此艺术家吗？关于此艺术家，到底应该如何实现。关于此艺术家的意义其实就隐藏在我们的生活中，陶渊明讲过一句话，盛年不重来，一日难再晨。及时当勉励，岁月不待人。这似乎非常的有道理，对吧？我们一般认为，抓住了问题的关键，其他一切则会迎刃而解。为什么是这样呢？我认为，既然是这样，经过上述讨论，其实关于此艺术家是非常值得我们深思的。更多关于此艺术家的意义是这样的，既然如此，生活中，若关于此艺术家出现了，我们就不得不考虑它出现了的事实。")
      }
    } catch (e) {
      ...
      <div className="flex justify-center">
        <div className="p-10 w-[70em]">
          <div className="lg:grid gap-10 grid-cols-10">
            ...
            <div className="col-span-4 bg-gray-50 p-10">
              ...
              <p className="flex items-center">
                <img className="mr-2" src="/tick.svg"></img>{uri}
              </p>
              <p className="flex items-center">
                <img className="mr-2" src="/tick.svg"></img>{sep}
              </p>
          ...
          <p className="p-5 bg-black text-white font-bold flex items-center">
            <img className="mr-2" src="/verified.svg"></img>{ssva}
          </p>
          <p className="text-xs underline cursor-pointer">
            {lmaovp}
          </p>
            ...
            <div className="lg:flex items-center">
              ...
              <div className="mt-5 lg:mt-0 lg:ml-10">
                ...
                <p className="mt-5 p-5 bg-black text-white font-bold flex items-center">
                  <img className="mr-2" src="/verified.svg"></img>{ssva2}
                </p>
                <p className="text-xs underline cursor-pointer">
                  {lmaovp}
                </p>
